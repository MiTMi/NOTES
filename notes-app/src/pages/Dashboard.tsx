...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    console.log('Loading notes for user:', user.email, 'with ID:', user.id, 'using key:', notesKey)
    ...
    if (savedNotes) {
      ...
      console.log('No saved notes found for this user')
      setNotes([])
    }
  ...
  useEffect(() => {
    ...
    console.log('Saving', notes.length, 'notes for user:', user.email, 'with ID:', user.id, 'using key:', notesKey)
    localStorage.setItem(notesKey, JSON.stringify(notesToSave))
    
    // Debug: Show all keys in localStorage
    console.log('All localStorage keys:', Object.keys(localStorage))
  }, [notes, user?.id, isInitialized])
