...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-navy-dark dark:via-navy-light dark:to-navy-dark flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card animate-scale-in">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Start taking beautiful notes today</p>
